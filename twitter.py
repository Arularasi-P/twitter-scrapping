...
client = pymongo.MongoClient("mongodb+srv://gparularasi:arasi123@cluster0.zb2lkpc.mongodb.net/?retryWrites=true&w=majority")
twtdb = client.arularasi
twtdb_main = twtdb.twitterproj

# main functions codings
def main():
  tweets = 0
  st.title("Elon Musk")
  ...
  if choice=="Home":
    ...
    image = Image.open(r"C:\arularasi\GUVI\twitter_proj\elonmusktwt.png") 
